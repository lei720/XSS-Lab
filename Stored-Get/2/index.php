...
<h3>Stored XSS [ Method : GET ] : LEVEL 2</h3>
<script src="../../Includes/Script/script.js"></script>
<form action="" method="GET"> 
<a href="../1/index.php"><img src="../../Includes/Image/previous.png" width="150px" height="150px" title="Previous Step"></a>
<textarea name="text" ></textarea>
<a href="../3/index.php"><img src="../../Includes/Image/next.png" width="150" height="150px" title="Next Step"></a><br>
...
?>
    ...
    <th>Your Comment:</th>
    	<td id="td_id"><?php echo $result['id']."~~~>"; ?></td>
	 	<td id="td_input"><input type="text" name="bypass" value="<?php echo base64_decode($result['input']); ?>"></td>
	</tr>
    </table>
<?php
	}
