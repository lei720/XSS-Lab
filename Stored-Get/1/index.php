...
<h3>Stored XSS [ Method : GET ] : LEVEL 1</h3>
...
<input type="button" name="home" value="Checklist" onclick="window.open('../../Checklist/index.php')"><br><br>
<?php
...
//get input
$string = base64_encode($_GET['text']);
	if (isset($_GET['send'])){
